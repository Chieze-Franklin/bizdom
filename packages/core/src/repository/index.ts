...
export interface IRepository<T> {
    // aggregate<T>(params?: IQueryBuilder<T>): Promise<T[]>;
    ...
    // distinct<T>(params: IQueryBuilder<T>): Promise<T[]>;
    // drop<T>(name: string, params: IQueryBuilder<T>): Promise<number>;
    exists<T>(params: IQueryBuilder<T>): Promise<boolean>;
    get(id: string): Promise<T | null>;
    getMany(params?: IQueryBuilder<T>): Promise<T[]>;
    // group<T>(name: string, params?: IQueryBuilder<T>): Promise<number>;
