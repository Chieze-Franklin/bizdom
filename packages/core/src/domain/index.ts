...
export class Domain {
    ...
    async getMany<T extends ModelDefinition>(params: QueryParams, meta?: QueryMeta): Promise<Array<T>> {
        return [];
    }
    ...
    // async find<T extends ModelDefinition>(name: string, query: any): Promise<Array<T>> {}
    ...
    // async aggregate<T extends ModelDefinition>(name: string, query: any): Promise<Array<T>> {}

    // async distinct<T extends ModelDefinition>(name: string, query: any): Promise<Array<T>> {}
...
export type QueryMeta = {
    domainAccessObjects?: Array<string>; // TODO: strongly type this string to names of DAOs
};